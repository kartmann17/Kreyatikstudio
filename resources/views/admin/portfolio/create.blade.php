    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="border-b border-gray-200 px-6 py-4">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-medium text-gray-900">Nouvel élément</h3>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="title" name="title" value="{{ old('title') }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="description" name="description" rows="4" required>{{ old('description') }}</textarea>
                        </div>

                        <div>
                            <label for="technology" class="block text-sm font-medium text-gray-700 mb-2">Technologies utilisées</label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="technology" name="technology" value="{{ old('technology') }}" placeholder="ex: HTML, CSS, JavaScript, Laravel, etc.">
                        ...
                        <div>
                            ...
                            <input type="url" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="url" name="url" value="{{ old('url') }}" placeholder="https://exemple.com">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="file" class="block text-sm font-medium text-gray-700 mb-2">
                                Fichier (Image/Vidéo) <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                                <input type="file" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 border border-gray-300 rounded-lg cursor-pointer focus:ring-2 focus:ring-blue-500 focus:border-blue-500" id="file" name="file" required accept=".jpg,.jpeg,.png,.gif,.mp4,.webm">
                            </div>
                            <p class="mt-1 text-sm text-gray-500">Formats acceptés: JPEG, PNG, GIF, MP4, WEBM. Taille max: 20MB.</p>
                        </div>

                        <div>
                            <div class="flex items-center">
                                <input type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" id="is_visible" name="is_visible" value="1" {{ old('is_visible', true) ? 'checked' : '' }}>
                        ...
                        <div>
                            <div id="preview-container" class="text-center hidden">
                                <h5 class="text-lg font-medium text-gray-900 mb-4">Aperçu</h5>
