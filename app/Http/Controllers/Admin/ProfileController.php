...
class ProfileController extends Controller
{
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('admin.profile.index', ['#change-password'])->with('success', 'Votre mot de passe a été mis à jour avec succès.');
    }
    ...
    public function updatePreferences(Request $request)
    {
        ...
        return redirect()->route('admin.profile.index', ['#preferences'])->with('success', 'Vos préférences ont été mises à jour avec succès.');
    }
} 